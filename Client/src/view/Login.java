...
public class Login extends JPanel implements ActionListener{
	...
	public void actionPerformed(ActionEvent arg0) {
		  if(arg0.getSource() == btnConnec || arg0.getSource() == password || arg0.getSource() == login){
			  ...
			  if(res){
				  javax.swing.JOptionPane.showMessageDialog(this,"Connexion réussie"); //on affiche le rÃ©sultat dans un pop-up
				  Main.getView().setPanel("Browser"); //si la connexion rÃ©ussit, on passe Ã  la selection d'une partie
				  
			  }
			  else
				  javax.swing.JOptionPane.showMessageDialog(this,"Connexion échouée");
		  } 
	}
}
